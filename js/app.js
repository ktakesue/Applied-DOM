(function(window) {
   ...
   */
  document.getElementById('btn3').addEventListener('click', setMyLightGreen);
   ...
   *     event, 'light-green'
   */
  document.getElementById('btn12').addEventListener('click', function(event){
   ...
   *     event, 'light-green'
   */
  document.getElementById('btn13').addEventListener('click', function(event){
   ...
   */
  document.getElementById('btn15').addEventListener('click', setMyLightClass.bind(btn15, event, 'light-green'));
